#!/usr/bin/env python3
"""
This module contains an asynchronous function `wait_random` that 
waits for a random
delay between 0 and `max_delay` seconds, and then returns the delay.

The script demonstrates how to use asynchronous programming 
...
async def wait_random(max_delay=10.0):
    ...
    This function generates a random float number between 0 
    ...
    Args:
        max_delay (float, optional): The 
        maximum delay time in seconds. Defaults to 10.0.
